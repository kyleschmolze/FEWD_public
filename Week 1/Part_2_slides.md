...
- Relative file path
  - Relative to where the html file is
  - Specify directories like `images/cookies.jpg`
  - Go up a directory with `../`
- Absolute file path
  - Starts with `/`
  - Generally reserved for webpages hosted online already
  - Ex: `<img src="https://ga-core.s3.amazonaws.com/production/uploads/program/default_image/397/thumb_User-Experience-Sketching.jpg">`
- Complete URLs
  - With `http` at the beginning

__Note:__ The `href` attribute in `<a>` tags work the same way!
